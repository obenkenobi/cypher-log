...
type UserChange1Listener interface {
	lifecycle.Closable
	ListenUserChange()
}

type UserChange1ListenerImpl struct {
...
func (k UserChange1ListenerImpl) ListenUserChange() {
...
func (k UserChange1ListenerImpl) Close() error {
