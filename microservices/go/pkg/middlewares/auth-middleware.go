...
func NewAuthMiddlewareImpl(
	jwtValidateWebAppService securityservices.JwtValidateWebAppService,
) *AuthMiddlewareImpl {

	jwtMiddleware := jwtmiddleware.New(jwtValidateWebAppService.GetJwtValidator().ValidateToken)
